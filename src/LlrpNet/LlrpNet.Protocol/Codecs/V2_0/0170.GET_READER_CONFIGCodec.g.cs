...
internal sealed class GET_READER_CONFIGCodec : global::LlrpNet.Protocol.Codecs.LlrpMessageCodec<global::LlrpNet.Protocol.Messages.V2_0.GET_READER_CONFIG>
{
    ...
    public override global::LlrpNet.Protocol.Messages.V2_0.GET_READER_CONFIG Decode(
        ...
        global::System.ReadOnlySpan<byte> payload)
    {
        ...
        global::LlrpNet.Protocol.Enumerations.V2_0.GetReaderConfigRequestedData RequestedData = GeneratedCodecRuntime.ReadEnum<global::LlrpNet.Protocol.Enumerations.V2_0.GetReaderConfigRequestedData>(reader.ReadByte());
        ...
        return new global::LlrpNet.Protocol.Messages.V2_0.GET_READER_CONFIG(
            header.MessageId,
            AntennaID,
            RequestedData,
            GPIPortNum,
    ...
    public override int GetEncodedPayloadLength(
        ...
        global::LlrpNet.Protocol.Messages.V2_0.GET_READER_CONFIG message)
    {
