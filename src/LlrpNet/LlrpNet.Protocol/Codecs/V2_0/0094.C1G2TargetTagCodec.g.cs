...
internal sealed class C1G2TargetTagCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V2_0.C1G2TargetTag>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V2_0.C1G2TargetTag Decode(
        ...
        global::System.ReadOnlySpan<byte> payload)
    {
        ...
        return new global::LlrpNet.Protocol.Parameters.V2_0.C1G2TargetTag(
            MB,
            Match,
            Pointer,
            TagMask,
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V2_0.C1G2TargetTag parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 3);
