...
internal sealed class CustomCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V2_0.Custom>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V2_0.Custom Decode(
        ...
        global::System.ReadOnlySpan<byte> payload)
    {
        ...
        return new global::LlrpNet.Protocol.Parameters.V2_0.Custom(
            VendorIdentifier,
            ParameterSubtype,
            Data);
    }
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V2_0.Custom parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 3);
