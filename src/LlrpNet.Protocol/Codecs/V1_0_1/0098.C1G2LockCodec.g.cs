...
internal sealed class C1G2LockCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.C1G2Lock>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.C1G2Lock Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.C1G2Lock parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
