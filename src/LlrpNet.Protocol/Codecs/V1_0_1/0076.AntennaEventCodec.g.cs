...
internal sealed class AntennaEventCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.AntennaEvent>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.AntennaEvent Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.AntennaEvent parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
