...
internal sealed class GPIPortCurrentStateCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.GPIPortCurrentState>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.GPIPortCurrentState Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.GPIPortCurrentState parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
