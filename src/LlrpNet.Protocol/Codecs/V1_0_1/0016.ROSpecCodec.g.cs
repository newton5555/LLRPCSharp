...
internal sealed class ROSpecCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpec>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpec Decode(
        ...
        global::System.ReadOnlySpan<byte> payload)
    {
        ...
        {
            ROBoundarySpec = GeneratedCodecRuntime.DecodeParameter<global::LlrpNet.Protocol.Parameters.V1_0_1.ROBoundarySpec>(registry, version, payload, ref offset);
        }
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpec parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
