...
internal sealed class EventNotificationStateCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.EventNotificationState>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.EventNotificationState Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.EventNotificationState parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
