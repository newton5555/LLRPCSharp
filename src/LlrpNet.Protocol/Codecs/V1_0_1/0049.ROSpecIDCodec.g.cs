...
internal sealed class ROSpecIDCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpecID>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpecID Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.ROSpecID parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
