...
internal sealed class ChannelIndexCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_0_1.ChannelIndex>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_0_1.ChannelIndex Decode(
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_0_1.ChannelIndex parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 1);
