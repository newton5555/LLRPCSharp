...
internal sealed class TagObservationTriggerCodec : global::LlrpNet.Protocol.Codecs.LlrpParameterCodec<global::LlrpNet.Protocol.Parameters.V1_1.TagObservationTrigger>
{
    ...
    public override global::LlrpNet.Protocol.Parameters.V1_1.TagObservationTrigger Decode(
        ...
        global::System.ReadOnlySpan<byte> payload)
    {
        ...
        int offset = 0;
        global::LlrpNet.Protocol.Enumerations.V1_1.TagObservationTriggerType TriggerType = GeneratedCodecRuntime.ReadEnum<global::LlrpNet.Protocol.Enumerations.V1_1.TagObservationTriggerType>(reader.ReadByte());
        ...
        return new global::LlrpNet.Protocol.Parameters.V1_1.TagObservationTrigger(
            TriggerType,
            NumberOfTags,
            NumberOfAttempts,
            T,
    ...
    public override int GetEncodedPayloadLength(
        global::LlrpNet.Core.Protocol.LlrpProtocolVersion version,
        global::LlrpNet.Protocol.Parameters.V1_1.TagObservationTrigger parameter)
    {
        GeneratedCodecRuntime.ValidateVersion(version, 2);
