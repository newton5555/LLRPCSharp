...
/// <summary>
/// Projects standard LLRP 2.0 access-report parameters into SDK tag observations.
/// </summary>
internal static class Llrp20TagReportTranslator
{
    ...
    private static (ReadOnlyMemory<byte> Bytes, int BitLength) GetElectronicProductCode(IEPCParameter parameter)
    {
        return parameter switch
        {
            ...
            _ => throw new NotSupportedException(
                $"Unsupported LLRP 2.0 EPC parameter type {parameter.GetType().FullName}."),
        };
    }
            ...
            switch (item)
            {
                case C1G2ReadOpSpecResult read:
                    results.Add(new TagAccessOperationResult(
                        read.OpSpecID,
                        read.Result == global::LlrpNet.Protocol.Enumerations.V2_0.C1G2ReadResultType.Success,
                        read.ReadData,
                        null,
                        read.Result == global::LlrpNet.Protocol.Enumerations.V2_0.C1G2ReadResultType.Success
                            ? null
                ...
                case C1G2WriteOpSpecResult write:
                    results.Add(new TagAccessOperationResult(
                        write.OpSpecID,
                        write.Result == global::LlrpNet.Protocol.Enumerations.V2_0.C1G2WriteResultType.Success,
                        [],
                ...
                case C1G2BlockWriteOpSpecResult blockWrite:
                    results.Add(new TagAccessOperationResult(
                        blockWrite.OpSpecID,
                        blockWrite.Result == global::LlrpNet.Protocol.Enumerations.V2_0.C1G2BlockWriteResultType.Success,
                        [],
                ...
                case C1G2LockOpSpecResult lockResult:
                    AddStatusOnlyResult(results, lockResult.OpSpecID, lockResult.Result, global::LlrpNet.Protocol.Enumerations.V2_0.C1G2LockResultType.Success);
                    break;
                case C1G2KillOpSpecResult kill:
                    AddStatusOnlyResult(results, kill.OpSpecID, kill.Result, global::LlrpNet.Protocol.Enumerations.V2_0.C1G2KillResultType.Success);
                    break;
                case C1G2BlockEraseOpSpecResult erase:
                    AddStatusOnlyResult(results, erase.OpSpecID, erase.Result, global::LlrpNet.Protocol.Enumerations.V2_0.C1G2BlockEraseResultType.Success);
                    break;
            }
        }
