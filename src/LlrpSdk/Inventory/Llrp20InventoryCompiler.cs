...
/// <summary>
/// Compiles the SDK inventory intent into the standard LLRP 2.0 ROSpec graph.
/// </summary>
internal static class Llrp20InventoryCompiler
{
        ...
        bool supportsStateAwareSingulation = false)
    {
        ...
        V20Parameters.C1G2TagInventoryStateAwareSingulationAction? stateAwareAction = CompileStateAwareAction(
        ...
        V20Parameters.C1G2SingulationControl? singulationControl = (settings.Session != 0 || settings.TagPopulationEstimate != 32 || stateAwareAction is not null)
            ? new V20Parameters.C1G2SingulationControl(settings.Session, settings.TagPopulationEstimate, 0, stateAwareAction)
            : null;
        V20Parameters.C1G2RFControl? rfControl = (settings.ModeIndex != 0 || settings.Tari != 0)
            ? new V20Parameters.C1G2RFControl(settings.ModeIndex, settings.Tari)
            : null;
        ...
        V20Parameters.C1G2InventoryCommand? invCmd = null;
        if (needsInventoryCommand)
        {
            invCmd = new V20Parameters.C1G2InventoryCommand(
        ...
        AntennaConfiguration[] antennaConfigs = settings.AntennaConfigurations.Count == 0
            ...
            : settings.AntennaConfigurations.Select(configuration => new AntennaConfiguration(
                ...
                configuration.ReceiverSensitivityIndex is ushort sensitivity ? new V20Parameters.RFReceiver(sensitivity) : null,
                configuration.TransmitPowerIndex is ushort transmitPower
                    ? new V20Parameters.RFTransmitter(configuration.HopTableId!.Value, configuration.ChannelIndex!.Value, transmitPower)
                    : null,
                invCmd is null ? [] : [invCmd])).ToArray();

        var aiSpec = new AISpec(
            antennaIds,
            new AISpecStopTrigger(V20Enumerations.AISpecStopTriggerType.Null, 0, null, null),
            [
                new InventoryParameterSpec(
                    settings.InventoryParameterSpecId,
                    V20Enumerations.AirProtocols.EPCGlobalClass1Gen2,
                    antennaConfigs,
        ...
        var reportSelector = new V20Parameters.TagReportContentSelector(
            ...
            EnableCryptoResponse: false,
            AirProtocolEPCMemorySelectorItems: settings.Report.IncludeCrc || settings.Report.IncludePcBits
                ? [new V20Parameters.C1G2EPCMemorySelector(settings.Report.IncludeCrc, settings.Report.IncludePcBits)]
                : Array.Empty<V20Choices.IAirProtocolEPCMemorySelector>());
        ...
        return new ROSpec(
            roSpecId,
            settings.Priority,
            V20Enumerations.ROSpecState.Disabled,
            boundary,
            [aiSpec],
            reportSpec);
    }
    ...
    private static IReadOnlyList<V20Parameters.C1G2Filter> CompileFilters(IReadOnlyList<InventorySelectFilter> filters) =>
        filters.Select(filter => new V20Parameters.C1G2Filter(
            V20Enumerations.C1G2TruncateAction.Do_Not_Truncate,
            new V20Parameters.C1G2TagInventoryMask((byte)filter.MemoryBank, filter.BitPointer, LlrpWireBits.ToBits(filter.Mask.Span, filter.BitLength)),
            filter.StateAwareAction is null ? null : new V20Parameters.C1G2TagInventoryStateAwareFilterAction(
                ToStateAwareTarget(filter.StateAwareAction.Target), ToStateAwareAction(filter.StateAwareAction.Action)),
            filter.StateAwareAction is null ? new V20Parameters.C1G2TagInventoryStateUnawareFilterAction(ToAction(filter.MatchAction, filter.NonMatchAction)) : null,
            ExtendOnTime: null)).ToArray();


    private static V20Enumerations.C1G2StateAwareTarget ToStateAwareTarget(InventoryFilterTarget target) => target switch
    {
        InventoryFilterTarget.SelectedFlag => V20Enumerations.C1G2StateAwareTarget.SL,
        InventoryFilterTarget.Session0 => V20Enumerations.C1G2StateAwareTarget.Inventoried_State_For_Session_S0,
        InventoryFilterTarget.Session1 => V20Enumerations.C1G2StateAwareTarget.Inventoried_State_For_Session_S1,
        InventoryFilterTarget.Session2 => V20Enumerations.C1G2StateAwareTarget.Inventoried_State_For_Session_S2,
        InventoryFilterTarget.Session3 => V20Enumerations.C1G2StateAwareTarget.Inventoried_State_For_Session_S3,
        _ => throw new ArgumentOutOfRangeException(nameof(target), target, null),
    };

    private static V20Enumerations.C1G2StateAwareAction ToStateAwareAction(InventoryFilterAction action) => action switch
    {
        InventoryFilterAction.AssertSelectedOrStateAAndDeassertSelectedOrStateB => V20Enumerations.C1G2StateAwareAction.AssertSLOrA_DeassertSLOrB,
        InventoryFilterAction.AssertSelectedOrStateAAndNoOperation => V20Enumerations.C1G2StateAwareAction.AssertSLOrA_Noop,
        InventoryFilterAction.NoOperationAndDeassertSelectedOrStateB => V20Enumerations.C1G2StateAwareAction.Noop_DeassertSLOrB,
        InventoryFilterAction.NegateSelectedOrStateAndNoOperation => V20Enumerations.C1G2StateAwareAction.NegateSLOrABBA_Noop,
        InventoryFilterAction.DeassertSelectedOrStateBAndAssertSelectedOrStateA => V20Enumerations.C1G2StateAwareAction.DeassertSLOrB_AssertSLOrA,
        InventoryFilterAction.DeassertSelectedOrStateBAndNoOperation => V20Enumerations.C1G2StateAwareAction.DeassertSLOrB_Noop,
        InventoryFilterAction.NoOperationAndAssertSelectedOrStateA => V20Enumerations.C1G2StateAwareAction.Noop_AssertSLOrA,
        InventoryFilterAction.NoOperationAndNegateSelectedOrState => V20Enumerations.C1G2StateAwareAction.Noop_NegateSLOrABBA,
        _ => throw new ArgumentOutOfRangeException(nameof(action), action, null),
    };

    private static V20Enumerations.C1G2StateUnawareAction ToAction(InventorySelectAction match, InventorySelectAction nonMatch) => (match, nonMatch) switch
    {
        (InventorySelectAction.Select, InventorySelectAction.Unselect) => V20Enumerations.C1G2StateUnawareAction.Select_Unselect,
        (InventorySelectAction.Select, InventorySelectAction.DoNothing) => V20Enumerations.C1G2StateUnawareAction.Select_DoNothing,
        (InventorySelectAction.DoNothing, InventorySelectAction.Unselect) => V20Enumerations.C1G2StateUnawareAction.DoNothing_Unselect,
        (InventorySelectAction.Unselect, InventorySelectAction.DoNothing) => V20Enumerations.C1G2StateUnawareAction.Unselect_DoNothing,
        (InventorySelectAction.Unselect, InventorySelectAction.Select) => V20Enumerations.C1G2StateUnawareAction.Unselect_Select,
        (InventorySelectAction.DoNothing, InventorySelectAction.Select) => V20Enumerations.C1G2StateUnawareAction.DoNothing_Select,
        _ => throw new ArgumentException("The specified inventory Select action pair is not supported by LLRP.")
    };

    private static V20Enumerations.ROReportTriggerType ToReportTrigger(InventoryReportTrigger trigger) => trigger switch
    {
        InventoryReportTrigger.None => V20Enumerations.ROReportTriggerType.None,
        InventoryReportTrigger.UponNTagsOrEndOfAiSpec => V20Enumerations.ROReportTriggerType.Upon_N_Tags_Or_End_Of_AISpec,
        InventoryReportTrigger.UponNTagsOrEndOfRoSpec => V20Enumerations.ROReportTriggerType.Upon_N_Tags_Or_End_Of_ROSpec,
        _ => throw new ArgumentOutOfRangeException(nameof(trigger), trigger, null),
    };

    private static ROSpecStartTrigger CompileStartTrigger(InventoryStartTrigger trigger) => trigger.Type switch
    {
        InventoryStartTriggerType.None => new(V20Enumerations.ROSpecStartTriggerType.Null, null, null),
        InventoryStartTriggerType.Immediate => new(V20Enumerations.ROSpecStartTriggerType.Immediate, null, null),
        InventoryStartTriggerType.Periodic => new(
            V20Enumerations.ROSpecStartTriggerType.Periodic,
            new V20Parameters.PeriodicTriggerValue(
                trigger.OffsetMilliseconds,
                trigger.PeriodMilliseconds,
                trigger.StartAtUtc is { } startAtUtc
                    ? new V20Parameters.UTCTimestamp(ToUtcMicroseconds(startAtUtc))
                    : null),
            null),
        InventoryStartTriggerType.Gpi => new(
            V20Enumerations.ROSpecStartTriggerType.GPI,
            null,
            new V20Parameters.GPITriggerValue(trigger.GpiPortNumber, trigger.GpiState, trigger.TimeoutMilliseconds)),
    ...
    {
        InventoryStopTriggerType.None => new(V20Enumerations.ROSpecStopTriggerType.Null, 0, null),
        InventoryStopTriggerType.Duration => new(V20Enumerations.ROSpecStopTriggerType.Duration, trigger.DurationMilliseconds, null),
        InventoryStopTriggerType.GpiWithTimeout => new(
            V20Enumerations.ROSpecStopTriggerType.GPI_With_Timeout,
            0,
            new V20Parameters.GPITriggerValue(trigger.GpiPortNumber, trigger.GpiState, trigger.TimeoutMilliseconds)),
        _ => throw new ArgumentOutOfRangeException(nameof(trigger), trigger.Type, null),
    };

    private static V20Parameters.C1G2TagInventoryStateAwareSingulationAction? CompileStateAwareAction(
        ...
        bool supportsStateAwareSingulation)
    {
        ...
        {
            InventoryTarget.StateA => V20Enumerations.C1G2TagInventoryStateAwareI.State_A,
            InventoryTarget.StateB => V20Enumerations.C1G2TagInventoryStateAwareI.State_B,
            _ => throw new ArgumentOutOfRangeException(nameof(action), action.Target, null),
        };
        var (selectedFlag, sAll) = action.SelectedFlag switch
        {
            InventorySelectedFlag.Set => (V20Enumerations.C1G2TagInventoryStateAwareS.SL, false),
            InventorySelectedFlag.Clear => (V20Enumerations.C1G2TagInventoryStateAwareS.Not_SL, false),
            InventorySelectedFlag.All => (V20Enumerations.C1G2TagInventoryStateAwareS.SL, true),
            _ => throw new ArgumentOutOfRangeException(nameof(action), action.SelectedFlag, null),
        };
        return new V20Parameters.C1G2TagInventoryStateAwareSingulationAction(target, selectedFlag, sAll);
    }
}
