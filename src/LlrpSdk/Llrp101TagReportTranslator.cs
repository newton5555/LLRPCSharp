            ...
            switch (item)
            {
                case C1G2ReadOpSpecResult read:
                    results.Add(new TagAccessOperationResult(
                        read.OpSpecID,
                        read.Result == global::LlrpNet.Protocol.Enumerations.V1_0_1.C1G2ReadResultType.Success,
                        read.ReadData,
                        null,
                        read.Result == global::LlrpNet.Protocol.Enumerations.V1_0_1.C1G2ReadResultType.Success
                            ? null
                ...
                case C1G2WriteOpSpecResult write:
                    results.Add(new TagAccessOperationResult(
                        write.OpSpecID,
                        write.Result == global::LlrpNet.Protocol.Enumerations.V1_0_1.C1G2WriteResultType.Success,
                        [],
