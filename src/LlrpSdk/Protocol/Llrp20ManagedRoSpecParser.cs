...
/// <summary>
/// Reverse-compiles the SDK-reserved LLRP 2.0 ROSpec (and optional attached-data AccessSpec) back into the
...
internal static class Llrp20ManagedRoSpecParser
{
    public static ParsedManagedRoSpec Parse(ROSpec roSpec, IReadOnlyList<ILlrpParameter> accessSpecs)
    {
        ...
        {
            throw new InvalidOperationException("The supplied V20Parameters.ROSpec is not the SDK-managed inventory V20Parameters.ROSpec.");
        }
        AISpec aiSpec = roSpec.SpecParameterItems.OfType<AISpec>().SingleOrDefault()
            ?? throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec must contain exactly one V20Parameters.AISpec.");
        ...
        {
            throw new InvalidOperationException("The reserved SDK AttachedData V20Parameters.AccessSpec is not associated with the reserved SDK V20Parameters.ROSpec.");
        }
        ...
        {
            throw new InvalidOperationException("The reserved SDK AttachedData V20Parameters.AccessSpec must contain a V20Parameters.C1G2Read operation.");
        }
            ...
            return new InventorySelectFilter
            {
                ...
                StateAwareAction = new InventoryStateAwareFilterAction
                {
                    Target = stateAware.Target switch
                    {
                        ...
                        _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec contains an unsupported state-aware filter target."),
                    },
    ...
    private static InventoryFilterAction ToFilterAction(C1G2StateAwareAction action) => action switch
    {
        ...
        _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec contains an unsupported state-aware filter action."),
    };
    ...
    private static InventoryStartTrigger ParseStartTrigger(ROSpecStartTrigger trigger) => trigger.ROSpecStartTriggerType switch
    {
        ...
        _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported or malformed start trigger."),
    };
    ...
    private static InventoryReportSettings ParseReportSettings(ROReportSpec? reportSpec)
    {
        ...
        {
            throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec must contain a V20Parameters.ROReportSpec.");
        }
        ...
        {
            throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported EPC report selector.");
        }
        return new InventoryReportSettings
        {
            Trigger = reportSpec.ROReportTrigger switch
            {
                ...
                _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported report trigger."),
            },
    ...
    private static InventoryStopTrigger ParseStopTrigger(ROSpecStopTrigger trigger) => trigger.ROSpecStopTriggerType switch
    {
        ...
        _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported or malformed stop trigger."),
    };
    ...
    private static InventoryStateAwareSingulation? ParseStateAwareSingulation(C1G2TagInventoryStateAwareSingulationAction? action) => action is null ? null : new InventoryStateAwareSingulation
    {
        Target = action.I switch
        {
            ...
            _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported state-aware singulation target."),
        },
        SelectedFlag = action.SAll ? InventorySelectedFlag.All : action.S switch
        {
            ...
            _ => throw new InvalidOperationException("The reserved SDK V20Parameters.ROSpec has an unsupported state-aware singulation flag."),
        },
    };
}
