...
/// <summary>LLRP 2.0 implementation of the SDK protocol-adapter boundary.</summary>
internal sealed class Llrp20ProtocolAdapter : ILlrpProtocolAdapter
{
    public LlrpProtocolVersion Version => LlrpProtocolVersion.Version20;
        ...
        CancellationToken cancellationToken)
    {
        GET_READER_CAPABILITIES_RESPONSE response = await reader
            .TransactDuringInitializationAsync<GET_READER_CAPABILITIES_RESPONSE>(
                new GET_READER_CAPABILITIES(messageId, V20Enumerations.GetReaderCapabilitiesRequestedData.General_Device_Capabilities, []),
                cancellationToken,
        ...
        GeneralDeviceCapabilities general = response.GeneralDeviceCapabilities ??
            throw new LlrpReaderInitializationException(
                "A successful LLRP 2.0 GET_READER_CAPABILITIES(General_Device_Capabilities) response must contain " +
        ...
        CancellationToken cancellationToken)
    {
        GET_READER_CAPABILITIES_RESPONSE response = await reader
            .TransactDuringInitializationAsync<GET_READER_CAPABILITIES_RESPONSE>(
                new GET_READER_CAPABILITIES(messageId, V20Enumerations.GetReaderCapabilitiesRequestedData.All, []),
                cancellationToken,
                MatchesCapabilitiesResponse)
            .ConfigureAwait(false);
        EnsureSuccess("GET_READER_CAPABILITIES", response.LLRPStatus);
        ...
        GeneralDeviceCapabilities general = response.GeneralDeviceCapabilities ??
            throw new LlrpReaderInitializationException(
                "A successful LLRP 2.0 GET_READER_CAPABILITIES(All) response must contain " +
                "exactly one GeneralDeviceCapabilities parameter.");
    ...
    public ILlrpParameter CompileInventory(
        ...
        Llrp20InventoryCompiler.Compile(settings, roSpecId, customItems.RoReportSpec, customItems.C1G2InventoryCommand, supportsStateAwareSingulation);

    public ILlrpParameter CompileTagAccess(uint accessSpecId, uint roSpecId, TagAccessRequest request, bool useBlockWrite = false) =>
        Llrp20TagAccessCompiler.Compile(accessSpecId, roSpecId, request, useBlockWrite);
    ...
    public ILlrpParameter CompileTagAccessSequence(
        ...
        Llrp20TagAccessCompiler.CompileSequence(accessSpecId, roSpecId, requests, useBlockWrite);

    public IReadOnlyList<TranslatedTagReport> TranslateTagReports(ILlrpMessage message) =>
        message is RO_ACCESS_REPORT report ? Llrp20TagReportTranslator.Translate(report) : [];
        ...
        IReadOnlyList<ILlrpParameter> accessSpecs)
    {
        ...
        ReaderCapabilities capabilities = reader.Capabilities ??
            throw new InvalidOperationException("Inventory settings query requires initialized reader metadata.");
        ParsedManagedRoSpec parsed = Llrp20ManagedRoSpecParser.Parse(
            roSpec as ROSpec ?? throw new ArgumentException(
                "The supplied ROSpec must be generated for LLRP 2.0 parameter type 177.",
                nameof(roSpec)),
            accessSpecs);
    ...
    public uint GetRoSpecId(ILlrpParameter item) => (item as ROSpec ?? throw new ArgumentException(
        "The supplied parameter is not an LLRP 2.0 ROSpec.", nameof(item))).ROSpecID;

    public InventoryRuntimeState GetRoSpecRuntimeState(ILlrpParameter item) => (item as ROSpec ?? throw new ArgumentException(
        "The supplied parameter is not an LLRP 2.0 ROSpec.", nameof(item))).CurrentState switch
    {
    ...
    public uint GetAccessSpecId(ILlrpParameter item) => (item as AccessSpec ?? throw new ArgumentException(
        "The supplied parameter is not an LLRP 2.0 AccessSpec.", nameof(item))).AccessSpecID;
    ...
    private static AccessSpec RequireAccessSpec(ILlrpParameter parameter) => parameter as AccessSpec ??
        throw new ArgumentException(
            "The supplied AccessSpec must be generated for LLRP 2.0 parameter type 207.",
            nameof(parameter));

    private static void EnsureSuccess(string operation, LLRPStatus status)
    {
        if (status.StatusCode != V20Enumerations.StatusCode.M_Success)
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        GET_READER_CONFIG_RESPONSE response = await reader
            .TransactAsync<GET_READER_CONFIG_RESPONSE>(
                new GET_READER_CONFIG(
                    messageId,
                    AntennaID: 0,
                    RequestedData: global::LlrpNet.Protocol.Enumerations.V2_0.GetReaderConfigRequestedData.All,
                    GPIPortNum: 0,
                    GPOPortNum: 0,
        ...
        {
            bool GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType type) =>
            ...
            {
                HoppingEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Upon_Hopping_To_Next_Channel),
                GpiEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.GPI_Event),
                RoSpecEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.ROSpec_Event),
                ReportBufferWarningEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Report_Buffer_Fill_Warning),
                ReaderExceptionEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Reader_Exception_Event),
                RfSurveyEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.RFSurvey_Event),
                AiSpecEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.AISpec_Event),
                AntennaEventEnabled = GetState(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Antenna_Event)
            };
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (configuration.Keepalive != null)
        {
            keepaliveSpec = new KeepaliveSpec(
                (global::LlrpNet.Protocol.Enumerations.V2_0.KeepaliveTriggerType)(int)configuration.Keepalive.TriggerType,
        ...
        if (configuration.Events != null)
        {
            ...
            {
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Upon_Hopping_To_Next_Channel, configuration.Events.HoppingEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.GPI_Event, configuration.Events.GpiEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.ROSpec_Event, configuration.Events.RoSpecEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Report_Buffer_Fill_Warning, configuration.Events.ReportBufferWarningEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Reader_Exception_Event, configuration.Events.ReaderExceptionEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.RFSurvey_Event, configuration.Events.RfSurveyEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.AISpec_Event, configuration.Events.AiSpecEventEnabled),
                new(global::LlrpNet.Protocol.Enumerations.V2_0.NotificationEventType.Antenna_Event, configuration.Events.AntennaEventEnabled)
            };
